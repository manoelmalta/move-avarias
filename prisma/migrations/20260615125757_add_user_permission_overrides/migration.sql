...
-- CreateIndex
CREATE INDEX "UserPermissionOverride_clientId_idx" ON "UserPermissionOverride"("clientId");
...
-- AddForeignKey
ALTER TABLE "UserPermissionOverride" ADD CONSTRAINT "UserPermissionOverride_clientId_fkey" FOREIGN KEY ("clientId") REFERENCES "Client"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
